...
public class FuncotatorIntegrationTest extends CommandLineProgramTest {
    ...
    // E coli data sources:
    private static final String DS_ECOLI_DIR             = toolsTestDir + "funcotator" + File.separator + "ecoli_ds" + File.separator;
    private static final String E_COLI_EXPECTED_OUT      = toolsTestDir + "funcotator" + File.separator + "e_coli.MG1655.expected_output.vcf";
